...
// multi_thread_gemm_no_pthread.h: Multi-threaded GEMM entry point.
// Uses std::thread etc. instead of pthread APIs for portability.
// Readers note: To understand this file, it is useful to first
// read and understand the much simpler single_thread_gemm.h.

#ifndef GEMMLOWP_INTERNAL_MULTI_THREAD_GEMM_NO_PTHREAD_H_
#define GEMMLOWP_INTERNAL_MULTI_THREAD_GEMM_NO_PTHREAD_H_
...
// conditional variable. In order to implement that correctly we need
...
//
template <typename T>
T WaitForVariableChange(volatile T* var, T initial_value,
...
#endif  // GEMMLOWP_INTERNAL_MULTI_THREAD_GEMM_NO_PTHREAD_H_
